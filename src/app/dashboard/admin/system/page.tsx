...
const TOOLS = [
  { href: '/dashboard/admin/system/feature-flags', icon: ToggleRight, label: 'Feature Flags', desc: 'Toggle features for your branch, or override per organization' },
]
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-0.5">Branch-wide controls and tools</p>
      </div>
