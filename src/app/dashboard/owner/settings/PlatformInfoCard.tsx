...
export default function PlatformInfoCard({ version = '—' }: { version?: string }) {
  return (
    <div className="card p-6">
      ...
      <div className="space-y-3">
        <a
          ...
          className="flex items-center justify-between px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 hover:border-navy-300 hover:bg-navy-50 transition-colors group"
        >
          <div className="flex items-center gap-3">
            <Globe size={16} className="text-navy-700" />
            <span className="text-sm font-medium text-slate-700">GetSuitel Website</span>
          </div>
          <span className="text-xs text-slate-400 group-hover:text-navy-600">getsuitel.com ↗</span>
        </a>
        <div className="flex items-center justify-between px-4 py-3 rounded-xl bg-slate-50 border border-slate-100">
          <span className="text-sm text-slate-500">Version</span>
          <span className="text-sm font-medium text-slate-700 font-mono">{version}</span>
        </div>
        <div className="flex items-center justify-between px-4 py-3 rounded-xl bg-slate-50 border border-slate-100">
