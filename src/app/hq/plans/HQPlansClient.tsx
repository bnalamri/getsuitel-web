...
const CURRENCY_OPTIONS = ['OMR','SAR','AED','KWD','QAR','BHD','USD','GBP','EUR']
                ...
                <div className="flex items-center gap-4 p-5">
                  ...
                  <div className="flex items-center gap-6 text-sm flex-shrink-0">
                    <div className="text-center">
                      <p className="font-bold text-slate-900 text-lg inline-flex items-center gap-1"><CurrencyIcon code={plan.currency} />{plan.price_monthly}<span className="text-xs text-slate-400 font-normal">/mo</span></p>
                    </div>
