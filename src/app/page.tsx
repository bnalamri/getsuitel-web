...
import { Building2, Users, FileText, Receipt, Wrench, BarChart2, Bell, DoorOpen, CheckCircle, ArrowRight, Shield, HardHat, Home, CheckCircle2, Clock, AlertCircle, TrendingUp, Store, PlayCircle } from 'lucide-react'

const content = {
  en: {
    dir: 'ltr', lang: 'ع',
    nav: { features: 'Features', explore: 'Explore', forWho: "Who it's for", pricing: 'Pricing', signin: 'Sign in', trial: 'Sign Up', marketplace: 'Suitel Marketplace', demo: 'Watch Demo' },
    ...
    footer: { desc:'Smart real estate management platform for property owners, tenants, and service teams.', product:'Product', legal:'Legal', links:{ features:'Features', pricing:'Pricing', signup:'Sign Up', signin:'Sign In', marketplace:'Suitel Marketplace', demo:'Watch Demo' }, legal_links:{ privacy:'Privacy Policy', terms:'Terms of Service', contact:'Contact Us' }, copyright:'GetSuitel. All rights reserved.', status:'All systems operational' },
  },
  ar: {
    dir: 'rtl', lang: 'EN',
    nav: { features: 'المميزات', explore: 'استكشف', forWho: 'لمن هو؟', pricing: 'الأسعار', signin: 'تسجيل الدخول', trial: 'إنشاء حساب', marketplace: 'سوق سويتل', demo: 'شاهد العرض' },
    ...
    footer: { desc:'منصة إدارة العقارات الذكية للملاك والمستأجرين وفرق الخدمة.', product:'المنتج', legal:'قانوني', links:{ features:'المميزات', pricing:'الأسعار', signup:'إنشاء حساب', signin:'تسجيل الدخول', marketplace:'سوق سويتل', demo:'شاهد العرض' }, legal_links:{ privacy:'سياسة الخصوصية', terms:'شروط الخدمة', contact:'تواصل معنا' }, copyright:'GetSuitel. جميع الحقوق محفوظة.', status:'جميع الأنظمة تعمل' },
  },
} as const
