...
const T = {
  en: {
    ...
    placeholder: 'GetSuitel HQ — standard reference pricing',
    month: '/mo',
    trial: 'day free trial',
    cta: 'Start Free Trial',
    hqNote: 'You’re viewing GetSuitel HQ’s standard reference pricing. Select a branch above to see your market’s actual plans.',
  ...
  ar: {
    ...
    pick: 'اختر فرعك',
    placeholder: 'مقر GetSuitel — الأسعار المرجعية القياسية',
    month: '/شهرياً',
    trial: 'يوم تجربة مجانية',
    cta: 'ابدأ التجربة المجانية',
    hqNote: 'أنت تشاهد الآن الأسعار المرجعية القياسية لمقر GetSuitel. اختر فرعاً أعلاه لعرض خطط وأسعار منطقتك.',
